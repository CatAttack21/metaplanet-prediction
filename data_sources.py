...
def get_metaplanet_data():
    """
    Pulls price and volume data for Metaplanet from all 3 tickers and aggregates volume
    ...
    if not all_data:
        raise ValueError("No Metaplanet data could be retrieved from any ticker")
